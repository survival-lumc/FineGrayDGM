...
- [`helpers.R`](./helpers.R) - helper functions that `manuscript-figures.R` relies on to compute true cumulative incidence function, cause-specific hazards, and subdistribution hazards, for both events.
